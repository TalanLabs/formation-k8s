...
variable "participants" {
  ...
  type  = list(string)
  default = [ "thomas.cami", "damien.lequeux", "diane.cordier", "gregoire.joncour", "guy.talomnoumsi", "joel.sagnon", "mahfoud.boukert" , "mohamed.boubaker", "monika.rakoczy", "sandrine.holmesnana", "sassi.bensaadallah", "stephane.thurneyssen", "victor.bonifaciocarre", "vincent.rojo", "yamen.bannour"]
}
